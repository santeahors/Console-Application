...
Public Class Recordform
    Private Sub LoadUserRecords(ByVal connection As MySqlConnection)
        Try
            Dim query As String = "SELECT * FROM auto_system2024.users_tab"
    ...
    Private Sub closed_btn_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles close_btn.Click
