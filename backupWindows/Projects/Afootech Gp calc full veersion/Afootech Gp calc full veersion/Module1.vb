Module Module1
    Sub Main()
        ...
        Do
            Dim SDT101, MAD102, SDA103, WAD104, NS105, AGD106, tp1, tp2, tp3, tp4, tp5, tp6, tp7, tp8, tp9, tp10, tp11, tp12, total_point, DBMS201, UIUX202, AI203, AA205, SQT204, DevOps206, gp, gp2 As Double
            Dim op As String
            Dim pass As String
            Dim input As String
            ...
            If op = "2" Then
                Do
                    ...
                    Console.WriteLine("=======================================")
                    Console.WriteLine("Your Grade-Point(GP) is " + gp.ToString("N2"))
                    Console.WriteLine("Your Cummutative Grade-Point Remark is " + cgpa.ToString)
                    Console.WriteLine("Your Grade-Point Remark is " + pass)
